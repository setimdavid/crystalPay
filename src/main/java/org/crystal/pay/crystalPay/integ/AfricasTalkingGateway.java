...
package org.crystal.pay.crystalPay.integ;
...
import org.crystal.pay.crystalPay.config.properties.AfricasTalkingProperties;
import org.crystal.pay.crystalPay.config.properties.AsyncHttpClientProperties;
...
public class AfricasTalkingGateway {
    ...
    @Autowired
    public AfricasTalkingGateway(AsyncHttpClientProperties asyncHttpClientConfigProperties, AfricasTalkingProperties properties) {
    ...
    private JSONArray sendPostSmsRequest(HashMap<String, String> dataMap, String urlString, String httpMethod) throws IOException {
        ...
        try (AsyncHttpClient client = asyncHttpClient(cf)) {
            ...
            builder
                    ...
                    .addHeader(properties.getUrlHeaderApiKeyword(), properties.getUrlHeaderApiData())
                    .build();
    ...
    public JSONArray sendMessage(String to_, String message_, String from_) throws Exception {
        ...
        data.put(properties.getIntegUsernameKeyword(), properties.getIntegUsernameData());
